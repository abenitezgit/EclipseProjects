...
public class mysqlDB {
	static Logger logger = Logger.getLogger("mysqlDB");
        /*
    ...
    */
    ...
    public mysqlDB(String vHost, String dbName, String dbPort, String dbUser, String dbPass) {
        v_hostIP = vHost;
        v_dbName = dbName;
        v_dbPort = dbPort;
        v_dbUser = dbUser;
    ...
    */
    ...
    public mysqlDB conectar() throws ClassNotFoundException {
        ...
        Class.forName("com.mysql.jdbc.Driver");
         ...
         //String BaseDeDatos = "jdbc:mysql://"+v_hostIP+":"+v_dbPort+"/"+v_dbName+"?zeroDateTimeBehavior=convertToNull";
         String BaseDeDatos = "jdbc:mysql://"+v_hostIP+"/"+v_dbName;
         //String BaseDeDatos = "jdbc:mysql://"+v_hostIP+";databaseName="+v_dbName+";user="+v_dbUser+";password="+v_dbPass;
         //String BaseDeDatos = "jdbc:sqlserver://" +v_hostIP + ":1433;databaseName=" + v_dbName+ ";integratedSecurity=true";
